    ...
    if (err) {
        ...
        `
          ...
          INSERT INTO Jogo (nome, cat, plataforma_que, nota, status, recomendacao, plataforma_disp) VALUES
            ('The Witcher 3', 'RPG', 'Epic Games Store', 9.5, 'zerado', 'Sim', 'Steam, Epic Games Store, Xbox Store'),
            ('Red Dead Redemption 2', 'Ação e Aventura', 'Steam', 9.8, 'zerado', 'Sim', 'Steam, Xbox One'),
            ('Animal Crossing: New Horizons', 'Simulação', 'Uplay', 9.0, 'jogado', 'Sim', 'G2A'),
            ('Cyberpunk 2077', 'RPG', 'Steam', 8.0, 'outros', 'Não', 'Xbox Store, Epic Games Store'),
            ('Among Us', 'Multijogador', 'Steam', 8.5, 'jogado', 'Sim', 'Steam'),
            ('The Legend of Zelda: Breath of the Wild', 'Ação e Aventura', 'PlayStation Store', 9.7, 'zerado', 'Sim', 'Steam'),
            ('GTA V', 'Ação e Aventura', 'PC', 9.3, 'zerado', 'Sim', 'PC, Epic Games Store, Xbox Store'),
            ('FIFA 23', 'Esportes', 'PlayStation Store', 8.2, 'jogado', 'Sim', 'Epic Games Store, PlayStation Store, Xbox Store'),
            ('Minecraft', 'Aventura', 'Epic Games Store', 9.0, 'zerado', 'Sim', 'Humble Store, PlayStation Store, Xbox Store'),
            ('Super Mario Odyssey', 'Ação e Aventura', 'Uplay', 9.5, 'zerado', 'Sim', 'GOG');
          `
                // Inserindo Jogos
